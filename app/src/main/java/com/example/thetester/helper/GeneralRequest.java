package com.example.thetester.helper;
...
import com.example.thetester.views.fragments.SubjectsFragment;
...
import static com.example.thetester.data.local.SharedPreferencesManger.USER_DATA;
import static com.example.thetester.data.local.SharedPreferencesManger.saveData;
                ...
                public void onResponse(@NonNull Call<GeneralResponse> call,@NonNull Response<GeneralResponse> response) {
                    try {
                        if (response.body().getStatus().equals("true")) {
                            ...
                            tinyDB.putListObject(USER_DATA , response.body().getData());
