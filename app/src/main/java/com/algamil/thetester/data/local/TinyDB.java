...
package com.algamil.thetester.data.local;
...
Bitmap getImage(String path) {
    ...
    public void putListObject(String key, List<GeneralResponseData> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    ...
    public void putListGeneralResponse(String key, List<GeneralResponseData> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(GeneralResponseData obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
